...
-- denomination = face value (nullable); grouping via category; upsert on (source, source_lot_id).
...
p_category, NULLIF(p_denomination,''), NULLIF(p_denomination_raw,''),
...
category=EXCLUDED.category, denomination=EXCLUDED.denomination, denomination_raw=EXCLUDED.denomination_raw,
